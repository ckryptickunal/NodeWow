...
import { orchestrateQueue, frameQueue } from '../queues.js';
import { runEvents, emitRunEvent, type RunEvent } from '../sse.js';
import { createRun, listRuns, getRunDetails, markRunKilled, resetRunForRetry } from '../runTracker.js';
...
export async function runsRoutes(app: FastifyInstance) {
  ...
  app.post('/api/runs', async (request, reply) => {
    ...
    await createRun(runId, collatedPrompt);
